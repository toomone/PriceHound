...
<div class="mb-6 rounded-lg border border-border bg-card shadow-sm">
	<div class="flex items-center justify-between gap-2 p-4">
		...
		<button
			...
			title="Open the Log Index Estimator"
			aria-label="Open Log Index Estimator"
		>
			...
			<span class="hidden sm:inline pointer-events-none">Log Index Estimator</span>
			<span class="sm:hidden pointer-events-none">Log Est.</span>
		</button>
	</div>
