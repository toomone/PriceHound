...
{#if tourCompleted}
	<button
		type="button"
		on:click={resetTour}
		class="fixed bottom-20 right-4 z-[60] inline-flex items-center gap-2 rounded-full bg-foreground px-4 py-2 text-sm font-medium text-background shadow-lg transition-all hover:scale-105 hover:bg-foreground/90"
